...
getgenv().kms = false
local Ihatethisui = {}
local UIName = 'RELKIN | .gg/7ewZEDUGJf'
local Amount = 0
local ConfigF
...
do
    ...
    function Library:CreateNotification(Title, Text, Duration)
        local Theme = {}
        local File = readfile('RELKIN_Hub.json')
        ...
        task.spawn(function()
            ...
            if not CoreGui:FindFirstChild('RELKIN | .gg/7ewZEDUGJf | Notifications') then
                Utility:Create('ScreenGui', {
                    Name = 'RELKIN | .gg/7ewZEDUGJf | Notifications',
                    Parent = CoreGui
                })
            else
                Utility:Create('Frame', {
                    Parent = CoreGui:FindFirstChild('RELKIN | .gg/7ewZEDUGJf| Notifications'),
                ...
                Amount = Amount + 1
                local Holder = CoreGui:FindFirstChild('RELKIN | .gg/7ewZEDUGJf | Notifications')['Notification'..tostring(Amount)]
        ...
        if not ImprovePerformance then
            ...
            elseif type(NewTheme) == 'string' then
                ...
                if NewTheme == 'custom' then
                    ...
                    writefile('RELKIN_Hub.json.json', HttpService:JSONEncode(NewTable))
                    Config['Theme_4z3s4QrUhfqt703FmiAe'] = HttpService:JSONEncode(NewTable)
                    ChangeThemeValue()
                ...
                elseif NewTheme == 'lighter' then
                    ...
                    writefile('RELKIN_Hub.json', HttpService:JSONEncode(NewTable))
                    Config['Theme_4z3s4QrUhfqt703FmiAe'] = HttpService:JSONEncode(NewTable)
                    ChangeThemeValue()
                ...
                Utility:Create('Frame', {
                    ...
                    Utility:Create('Frame', {
                        ...
                        Utility:Create('ImageLabel', {
                            ...
                            Image = 'rbxassetid://137510036117566',
